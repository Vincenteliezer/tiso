...
function AwardSection() {
  return (
    <>
    <h4 className="mt-5 text-gray-800 font-bold text-xl text-center md:text-start">PERFORMANCE DASHBOARD</h4>
      <div className="grid grid-cols-1 md:grid-cols-3 mt-10 place-items-center space-y-4 md:space-y-0">
        <div className="flex flex-col items-center text-center h-full">
          <Image src={champions} className="h-48 w-40" />
          <div>
        ...
        <div className="flex flex-col items-center text-center h-full">
          <Image src={silverwinner} className="h-48 w-40" />
          <div>
        ...
        <div className="flex flex-col items-center text-center h-full">
          <Image src={bronze} className="h-48 w-40" />
          <div>
